...
export default function SavedInvoices() {
  ...
  const handleProcessPayment = async (e) => {
    ...
    try {
      ...
      // After successful payment, ideally refetch all invoices or update the specific one
      // For this example, we're updating the specific invoice from the backend's response.
      // If your backend only sends a success message, you might need to refetch all.
      // E.g., await fetchInvoices(); // If you made fetchInvoices available outside useEffect or refactor
